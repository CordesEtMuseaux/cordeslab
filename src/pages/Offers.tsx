...
const PLANS_DATA: Record<"monthly" | "yearly", Plan[]> = {
  monthly: [
    ...
    { name: "Pro",     price: "29€", desc: "L'outil professionnel complet", planCode: "pro_monthly", features: ["Bibliothèque intégrale", "Sauvegarde illimitée", "Calculs Laisses & Accessoires"] }
  ],
  yearly: [
    { name: "Atelier", price: "0€",   desc: "Pour débuter sereinement",       current: true, planCode: null,             features: ["8 tressages essentiels", "Sauvegarde illimitée", "Calculs de base uniquement"] },
    ...
    { name: "Pro",     price: "279€", desc: "L'outil professionnel complet",  saving: "Économisez 69€/an", planCode: "pro_yearly", features: ["Bibliothèque intégrale", "Sauvegarde illimitée", "Calculs Laisses & Accessoires"] }
  ]
};
