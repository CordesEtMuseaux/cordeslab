...
export default function Settings() {
  ...
  // Données simulées (ton accès actuel)
  const userPlan = {
    name: "Pro",
  ...
  return (
    <div style={{ padding: "30px", maxWidth: "1200px", margin: "0 auto", backgroundColor: THEME.colors.primaryBg, minHeight: "100vh", fontFamily: "sans-serif" }}>
      ...
      <div style={{ marginBottom: "40px" }}>
        <h1 style={{ fontSize: "28px", fontWeight: "900", color: THEME.colors.textMain, margin: 0 }}>Réglages</h1>
        <p style={{ color: THEME.colors.textMuted, marginTop: "5px" }}>Gérez votre compte et les paramètres de CordesLab.</p>
      </div>

      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(450px, 1fr))", gap: "25px" }}>
        
        {/* --- SECTION COMPTE --- */}
        <section style={{ background: THEME.colors.cardBg, borderRadius: THEME.radius.card, border: `1px solid ${THEME.colors.border}`, padding: "25px", height: "fit-content" }}>
          <h2 style={{ fontSize: "20px", fontWeight: "800", marginBottom: "25px", color: THEME.colors.textMain }}>Compte</h2>
          ...
          <div style={{ marginBottom: "15px" }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
              ...
              <button onClick={() => toggleSection("sub")} style={{ padding: "8px 20px", borderRadius: "10px", border: "none", background: "#E0E0E0", cursor: "pointer", fontWeight: "bold", fontSize: "13px" }}>
            ...
            {openSection === "sub" && (
              <div style={{ marginTop: "20px", animation: "fadeIn 0.3s ease" }}>
                ...
                {/* 1. RÉSUMÉ DU COMPTE */}
                <div style={{ padding: "20px", background: "#F9F9F9", borderRadius: "15px", marginBottom: "20px" }}>
                  <h3 style={{ fontSize: "13px", fontWeight: "800", marginBottom: "15px", color: THEME.colors.accent, textTransform: "uppercase" }}>Résumé du compte</h3>
                ...
                {/* 2. RÉSUMÉ DES NIVEAUX */}
                <div style={{ padding: "20px", background: "#F9F9F9", borderRadius: "15px" }}>
                  <h3 style={{ fontSize: "13px", fontWeight: "800", marginBottom: "15px", color: THEME.colors.textMain, textTransform: "uppercase" }}>Offres disponibles</h3>
                  ...
                  <button 
                    ...
                    style={{ marginTop: "20px", width: "100%", padding: "12px", borderRadius: "10px", border: "none", background: THEME.colors.accent, color: "#fff", fontWeight: "bold", cursor: "pointer" }}
                  >
                    Changer de formule
                  </button>
                </div>
          ...
          {/* ACCORDÉON SUPPORT */}
          <div style={{ borderTop: `1px solid ${THEME.colors.border}`, paddingTop: "20px", marginTop: "10px" }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
              <div>
              ...
              <button onClick={() => toggleSection("support")} style={{ padding: "8px 20px", borderRadius: "10px", border: "none", background: "#E0E0E0", cursor: "pointer", fontWeight: "bold", fontSize: "13px" }}>
        ...
        {/* --- SECTION APPLICATION --- */}
        <section style={{ background: THEME.colors.cardBg, borderRadius: THEME.radius.card, border: `1px solid ${THEME.colors.border}`, padding: "25px", height: "fit-content" }}>
          <h2 style={{ fontSize: "20px", fontWeight: "800", marginBottom: "25px", color: THEME.colors.textMain }}>Application</h2>
          ...
          <div style={{ borderTop: `1px solid ${THEME.colors.border}`, paddingTop: "20px" }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
              ...
              <button onClick={() => toggleSection("ui")} style={{ padding: "8px 20px", borderRadius: "10px", border: "none", background: "#E0E0E0", cursor: "pointer", fontWeight: "bold", fontSize: "13px" }}>
